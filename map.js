...
function preload() {
    ...
    this.load.image('player-left', 'bunny_walk.png'); // Image pour le mouvement à gauche
    this.load.image('player-right', 'bunny_walk.png'); // Image pour le mouvement à droite
}
