...
function preload() {
  ...
  this.load.image("enemy", "bear_walk_look_right.png");

  // Ajout des différentes textures du joueur
  this.load.image("player", "rabbitAction1.png"); // Image par défaut
  this.load.image("player-jump", "rabbitAction2.png"); // Image de saut
  this.load.image("player-left", "rabbitAction3.png"); // Image pour le mouvement à gauche
  this.load.image("player-right", "rabbitAction4.png"); // Image pour le mouvement à droite
}
...
function create() {
  ...
  platforms
    .create(worldWidth / 2, worldHeight - 32, "ground")
...
function update() {
  ...
  if (cursors.left.isDown) {
    ...
    player.setTexture("player-left"); // Changer l'image du joueur quand il se déplace à gauche
  }
  // Si le joueur se déplace vers la droite
  else if (cursors.right.isDown) {
    player.setVelocityX(160);
    player.setTexture("player-right"); // Changer l'image du joueur quand il se déplace à droite
  }
